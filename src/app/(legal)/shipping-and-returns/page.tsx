  ...
  return (
    <>
      ...
      <aside className={styles.titleColumn}>
        <h1>Shipping <span>& Returns</span></h1>
      </aside>
      ...
      <section className={styles.contentColumn}>
        ...
        <div className={styles.section}>
          ...
          <div className={styles.block}>
          <p>
            At Mashi, every Mashi product is crafted by hand with care. We hope you love what you receive If something isn’t right we are here to help.
          </p>
          </div>
          ...
          <div className={styles.block}>
          <h3>Exchanges</h3>
          <p>We currently offer exchanges only for:</p>
          <ul>
